...
function Home() {
  ...
  return (
    <div dir="ltr" className="min-h-screen bg-[#F6E8CA] px-4 py-10 ">
      {/* תוכן ראשי */}
      <div className="font-georgia mt-25 max-w-7xl mx-auto flex flex-col lg:flex-row items-start justify-between gap-10 mb-16">
        <div className="lg:w-1/2 rounded-xl p-4 text-right mr-4 lg:mr-20 mt-18">
          <h2 className="text-2xl md:text-3xl font-bold text-green-900 mb-2">
            משלוחים למגוון אזורים בארץ
          </h2>
          <h1 className="font-georgia text-4xl md:text-5xl  text-green-900 mb-6">
          איכות, טריות, בריאות – בשביל זה אנחנו כאן         </h1>
          <p className="text-xl text-gray-800 leading-relaxed]">
          אנו משפחת זנזורי, ממושב שדה עוזיהו, מחזיקים משק חקלאי שעובר בדורות כבר 50 שנה<br />
          כיום, אנו מתמחים בגידול כל סוגי החסות, עגבניות חממה בגידול הידרופוני , ברוקולי, בצל, כרוב לבן ואדום, סלרי וסלק עלים<br />
          לפי כ-6 שנים האיכר זנזורי, שמעון, החליט לפתוח חנות משק לפירות וירקות ברמת פרימיום <br />
        ...
        <div className="lg:w-1/2 flex justify-center">
          <div className="rounded-full overflow-hidden w-[550px] h-[550px] mb-5">
            <img
              src="/images/veg.png"
              alt="חסה"
