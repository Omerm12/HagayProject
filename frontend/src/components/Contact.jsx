...
export default function Contact() {
  ...
  return (
    <footer className="text-white px-6 pt-6 pb-3 bg-[url('/images/footerBackground1.png')] bg-cover bg-center min-h-screen flex flex-col justify-center items-center">
        <div className="w-50 h-50 sm:w-40 sm:h-40 -mt-27 mb-10 bg-white rounded-full shadow-lg flex items-center justify-center overflow-hidden">
          <img
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-start text-right font-roboto text-white px-4 sm:px-6">
        {/* פרטים */}
        <div className="space-y-6 order-1 lg:order-1 lg:pr-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white flex items-center justify-center text-center">
            אנו מזמינים אתכם לפנות לשירות הלקוחות שלנו בכל שאלה או בקשה
          </h2>
          <p className="text-lg sm:text-xl md:text-2xl flex items-center justify-center text-center">
            שירות הלקוחות שלנו זמין וזמין בשבילכם, בימים א'-ה' מ־7:00 עד 22:00 וברביעי עד 14:00.
          </p>
          <div className="flex flex-col items-center text-lg sm:text-xl text-white gap-4 mt-8">
        ...
        <div className="p-6 rounded-md space-y-4 text-white order-2 lg:order-2 font-bold">
          <h3 className="text-xl sm:text-2xl font-bold">אפשר גם למלא טופס פנייה ונענה במהירות :)</h3>
      ...
      <div className="w-full border-y-4 border-[#F6E8CA] text-white text-center py-3 mt-8 mb-3 px-2 overflow-hidden">
